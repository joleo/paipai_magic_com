...
"""
-------------------------------------------------
   File Name：     model_attention_feature
   Description :
   Author :       LiYang
   date：          7/8/18
-------------------------------------------------
...
save_data = _load('../data/nn_glove_embedding_wc_data.pkl')
...
embedding_matrix = save_data.char_embedding_matrix
...
for curr_fold, (idx_train, idx_val) in enumerate(folds):
    if curr_fold == 0:
        ...
        print("the best val score:"+ str(bst_val_score))
