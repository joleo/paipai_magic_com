...
print('the length of word_embed:', word_embedding_matrix.shape)
print('the length of char_embed:', char_embedding_matrix.shape)
...
q3 = Embedding(nb_words + 1,
                 ...
                 trainable=False)(question1)
q3 = TimeDistributed(Dense(EMBEDDING_DIM, activation='relu'))(q3)
...
q4 = Embedding(nb_words + 1,
                 ...
                 input_length=MAX_CHAR_SEQUENCE_LENGTH,
                 trainable=False)(question2)
q4 = TimeDistributed(Dense(EMBEDDING_DIM, activation='relu'))(q4)
q4 = Lambda(lambda x: K.max(x, axis=1), output_shape=(EMBEDDING_DIM, ))(q4)
