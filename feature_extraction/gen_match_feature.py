...
# stops = set(stopwords.words(stop_word))
stops = stop_word
...
df_feat[:len_train].to_csv(path + 'train_feature_match.csv', index=False)
df_feat[len_train:].to_csv(path + 'test_feature_match.csv', index=False)
