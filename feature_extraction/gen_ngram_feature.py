...
# 停用词english
stops = stop_word#set(stopwords.words("english"))
...
df_feature[:train.shape[0]].to_csv(path + 'train_ngram_feature.csv', index=False)
df_feature[train.shape[0]:].to_csv(path + 'test_ngram_feature.csv', index=False)