# -*- coding: utf-8 -*-
# @Time    : 6/21/18 7:50 AM
# @Author  : Mat
# @Email   : mat_wu@163.com
# @File    : gen_graph_chars_fre_feature.py
...
train_comb = comb[comb['label'] >= 0][['q1_hash','q2_hash','q1_freq','q2_freq','label']]
test_comb = comb[comb['label'] < 0][['q1_hash','q2_hash','q1_freq','q2_freq']]



path = '../data/pre_feature/'
train_comb[['q1_freq', 'q2_freq']].to_csv(path + 'train_feature_graph_chars_freq.csv', index=False)
test_comb[['q1_freq', 'q2_freq']].to_csv(path + 'test_feature_graph_chars_freq.csv', index=False)
